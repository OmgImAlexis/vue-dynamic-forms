...
export const required: ValidatorFn = (value: ControlValue): ValidationErrors => ({
  required: isEmptyInputValue(value) ? true : null,
});

export const min = (min: number): ValidatorFn => (value: ControlValue): ValidationErrors => {
...
export const max = (max: number): ValidatorFn => (value: ControlValue): ValidationErrors => {
...
export const email: ValidatorFn = (value: ControlValue): ValidationErrors => {
...
export const url: ValidatorFn = (value: ControlValue): ValidationErrors => {
  if (isEmptyInputValue(value)) {
...
export const maxLength = (maxLength: number): ValidatorFn => (
  value: ControlValue,
): ValidationErrors => {
  if (isEmptyInputValue(value)) {
